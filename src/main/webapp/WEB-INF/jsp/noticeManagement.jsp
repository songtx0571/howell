        ...
        <div class="content">
            ...
            <div class="addInfo">
                ...
                <div>
                    ...
                    <button type="button" class="layui-btn layui-btn-primary" id="test3" ><i class="layui-icon"></i>选择文件</button>
                    ...
                    <form class="layui-form" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline" style="width: 300px;float: left;margin-top: 10px;margin-left: -30px;">
